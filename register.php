	...
	if(isset($_POST['reg'])){
        ...
        if($doIt){
            ...
            */
            ...
            $sql = "insert into data values ('$_POST['username']','$_POST['pass']','$_POST['fname']','$_POST['lname']','$_POST['address']','$_POST['country']'), $_POST['birtdhay'];";
...
<html>
    ...
    <head>
        <title>Register at MovieDB</title>
    ...
    <body class="login-body">
        ...
        <div class="divreg" id="div1" align="center">
            ...
            <form method="post" name="loginform" action="register.php" enctype="multipart/form-data">
                ...
                <p class="login-sign">Already have an account ? <a href="../social/login.php">Click Here</a></p>
